...
FC_obj = SeasonalForecaster(model=model, target=Talas_Q.downsample('10-03'), Qm=Talas_Q, Pm=Talas_P, Sm=Talas_S, Tm=Talas_T, forecast_month=10, earliest_month=None, max_features=2, n_model=20)
